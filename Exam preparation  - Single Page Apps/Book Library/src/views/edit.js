            ...
            <form @submit=${onSubmit} id="edit-form" action="#" method="">
                <fieldset>
                    ...
                    <p class="field">
                        ...
                        <span class="input">
                            <input type="text" name="title" id="title" .value="${currentData.title}">
                        </span>
                    </p>
                    <p class="field">
